...
## מבנה המטלה
במטלה זו תתבקשו ליצור ולממש את קבצי ה-`.cpp` ו-`.hpp` הנדרשים. המטלה מדגימה:
...
## דרישות והנחיות
- ליצור ולממש את כל הקבצים הנדרשים (פירוט ב-**קבצים במטלה**)
...
- **StudentTest.cpp** - קובץ בדיקות אישיות של הסטודנט (לכל הפחות 20 בדיקות)
